...
export function BookingFlow() {
  ...
  if (done) {
    return (
      <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}
        className="mx-auto max-w-xl rounded-3xl border bg-card p-10 text-center shadow-editorial sm:p-14">
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Button variant="outline" onClick={() => navigate({ to: "/" })} className="h-11 rounded-md px-6 text-[11px] font-semibold tracking-[0.22em]">VOLTAR AO SITE</Button>
        </div>
      </motion.div>
    );
  }
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
      <div className="rounded-3xl border bg-card p-6 shadow-luxe sm:p-9">
        {/* Progress bar */}
